...
exports.handler = async (event) => {
  ...
  async function getRandomQuote(apiURLInput) {
    ...
    <text x="${width / 2}" y="${
      height - 10
    }" class="footerStyles">Developed by 111 | Quotes from ZenQuotes.io</text>
    </svg>
    `;

    //Add background images for the svg creation
    const backgroundImages = [
      "backgrounds/Aubergine.jpg",
      "backgrounds/Mantle.jpg",
      "backgrounds/Midnight-City.jpg",
      "backgrounds/Orangey.jpg",
    ];
    ...
    try {
      ...
      console.log("error updating quote in DynamoDB", error);
    }
